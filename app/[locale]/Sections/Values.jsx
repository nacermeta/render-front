...
function values() {
  ...
  return (
    <div className='flex flex-col lg:flex-row lg:justify-center gap-2 px-4 lg:px-8 py-8'>
      ...
      <p className='mt-2 font-semibold'>{t('values.0.description')}</p>
      </div>
      <div className='flex flex-col shadow-2xl rounded-xl px-4 py-8 w-full md:w-1/2'>
      <GiReceiveMoney className='w-12 h-16'/>
      <h2 className='font-semibold md:text-lg mt-4'>{t('values.1.title')}</h2>
      <p className='mt-2 font-semibold'>{t('values.1.description')}</p>
      </div>
      </div>
      ...
      <p className='mt-2 font-semibold'>{t('values.2.description')}</p>
      </div>
      <div className='flex flex-col shadow-2xl rounded-xl px-4 py-8 w-full md:w-1/2'>
      <LuPhone className='w-12 h-16'/>
      <h2 className='font-semibold md:text-lg mt-4'>{t('values.3.title')}</h2>
      <p className='mt-2 font-semibold'>{t('values.3.description')}</p>
      </div>
      </div>
    </div>
  )
